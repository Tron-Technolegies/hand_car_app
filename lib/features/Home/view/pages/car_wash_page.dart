    ...
    return OnBoardingSlider(
      ...
      onFinish: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const NameAndEmailPage(),
          ),
        );
      },
      ...
      background: [
        Lottie.asset(Assets.animations.carAnimation, width: 600, height: 600),
        Lottie.asset(Assets.animations.carService, width: 600, height: 600),
        Lottie.asset(Assets.animations.carWash, width: 600, height: 600),
      ],
      speed: 1.8,
      pageBodies: [
        Container(
